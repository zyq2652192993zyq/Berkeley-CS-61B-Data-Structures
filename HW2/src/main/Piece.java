...
public class Piece {
    ...
    public Piece computeNextRotation() {
        ...
        int cnt = 0;
        for (TPoint point : body) {
            int newX = -point.y + height - 1;
            int newY = point.x;
            points[cnt++] = new TPoint(newX, newY);
        }
        Arrays.sort(points);
    ...
    public boolean equals(Object obj) {
        ...
        return Arrays.equals(this.body, other.getBody());
    }
	...
	*/
    private static Piece makeFastRotations(Piece root) {
        buildCircularList(root, root);
        return root;
    }

    private static void buildCircularList(Piece root, Piece cur) {
        ...
        if (nextPiece.equals(root)) {
            ...
            buildCircularList(root, nextPiece);
        }
    }
