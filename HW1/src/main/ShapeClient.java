...
public class ShapeClient {
    public static void main(String[] args) {
        ...
        System.out.println("a crosses b:" + a.crossess(b));
        System.out.println("a crosses c:" + a.crossess(c));
        System.out.println("a crosses d:" + a.crossess(d));
        System.out.println("a encircles b:" + a.encircles(b));
        System.out.println("a encircles c:" + a.encircles(c));
        System.out.println("a encircles c:" + a.encircles(d));
    }
}
